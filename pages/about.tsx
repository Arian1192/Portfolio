	...
	return (
		<div>
            ...
            animate-text"
					...
					<p className="p-5 text-white text-2xl max-sm:text-[16px]">
						One thing that describes me very well is that I like to teach what I
						learn, and to help others in their endeavours.{" "}
					</p>
					<p className="p-5 text-white text-2xl max-sm:text-[16px]">
						I love researching, working in teams and trying new technologies, I
						believe that learning should never stop and that makes me keep an
				...
				<div className="mx-auto  overflow-hidden p-10 w-3/5 max-lg:w-3/5 max-md:w-[500px] md:w-[900px] max-sm:w-full">
					<div className="w-4/4 flex flex-row p-5  max-md:flex-row   max-sm:flex-col max-sm:w-full">
						...
						<motion.div
							className=" p-5 w-3/6 border flex flex-row items-center justify-start max-md:w-4/5 max-sm:w-full"
							initial={{ opacity: 0, x: 400 }}
							animate={{ opacity: 1, x: 0 }}
							transition={{ duration: 1.3 }}
						>
							<ul>
								<li className="text-white text-[16px] mb-5">
									After finishing my Máster in Full Stack Development, I started
									to develop for{" "}
									<span className="font-semibold">BLUEMOTION-COMPETITION</span>{" "}
									their landing page.{" "}
								</li>
								...
								<li className="text-white text-[16px]">
									The academy where I studied the Master, offered me to mentor
									the students of the next edition, to help them in their
				...
				<div className="w-3/5 mx-auto max-md:w-11/12 flex flex-row items-start justify-around gap-5 py-5 max-sm:grid grid-cols-2 max-sm:w-full">
					{technology.map((technology) => (
						<div className="text-white" key={technology.id}>
							<TechnologyCard
								key={technology.id}
								typeOfSoftware={technology.typeOfSoftware}
							/>
						</div>
					))}
				</div>
