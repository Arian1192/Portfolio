		...
		<div>
            ...
            animate-text"
						...
						<p className="p-5 text-white text-2xl max-sm:text-[16px]">
							One thing that describes me very well is that I like to teach what
							I learn, and to help others in their endeavours.{" "}
						</p>
						<p className="p-5 text-white text-2xl max-sm:text-[16px]">
							I love researching, working in teams and trying new technologies,
							I believe that learning should never stop and that makes me keep
							...
							>
								<ul>
									<li className="text-white text-[16px] mb-5">
										After finishing my Máster in Full Stack Development, I
										started to develop for{" "}
										<span className="font-semibold">
											BLUEMOTION-COMPETITION
										</span>{" "}
										their landing page.{" "}
									</li>
