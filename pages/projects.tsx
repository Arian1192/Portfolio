	...
	return (
		<div className="overflow-hidden">
			...
			<main>
				...
				<div className="w-3/5 p-5 gap-10 mx-auto flex flex-row flex-wrap justify-around items-center lg:w-3/5 max-md:w-3/5 md:w-full max-sm:w-full max-sm:flex-col">
